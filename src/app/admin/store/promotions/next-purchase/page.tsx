...
import { Button, Divider, NumberInput, Select, SelectItem } from "@heroui/react"
            ...
            <div className="bg-white rounded-2xl p-4 py-6 flex flex-col items-center gap-4">
                <div className="w-full flex flex-col gap-6 text-start">
                    <div className="flex flex-col gap-2">
                        ...
                        <small className="text-gray-600">در این گزینه شما انتخاب می‌کنید که کد تخفیف بعد از ارسال شدن تا چه مدت زمانی برای کاربر قابل استفاده و در دسترس باشد.</small>
                    </div>
                    <div>
                        <Divider />
                ...
                <div className="w-full text-end">
                    <Button color="secondary" variant="flat">ایجاد پروموشن</Button>
                </div>
            </div>
        </div>
    )
