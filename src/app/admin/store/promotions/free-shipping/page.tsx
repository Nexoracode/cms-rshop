...
const FreeShipping = () => {
    ...
    const [selectedArea, setSelectedArea] = useState<"nationwide" | "coveredArea">("nationwide");
    const [selectedMethod, setSelectedMethod] = useState<"unlimit" | "minimum" | "count">("unlimit");
            ...
            <Card className="shadow-md mt-6">
                ...
                <CardBody className="flex flex-col gap-6 text-right">
                    <div className="flex flex-col gap-4">
                        ...
                        />
                        <small className="text-gray-600">مشتریان شما، موضوع این تخفیف را در سبد خرید و صورتحساب خود می‌بینند.</small>
                    </div>
                    <Divider />
                    <div>
                        <RadioGroup isRequired label="محدوده اعمال تخفیف" value={selectedArea} onValueChange={(val) => setSelectedArea(val as any)}>
                    ...
                    <Divider />
                    <div className="flex flex-col gap-4">
                        <RadioGroup isRequired label="نحوه اعمال تخفیف" value={selectedMethod} onValueChange={(val) => setSelectedMethod(val as any)}>
                            <Radio value="unlimit">بدون محدودیت</Radio>
                            <Radio value="minimum">حداقل مبلغ سبد خرید برای استفاده از تخفیف</Radio>
                    ...
                    <Divider />
                    <div className="flex flex-col gap-4">
                        <DateRangePicker label="زمان فعال بودن تخفیف" labelPlacement="outside" />
                    </div>

                    <div className="w-full text-end">
                        <Button color="secondary" variant="flat">تایید اطلاعات</Button>
                    </div>
                </CardBody>
            </Card>
        </>
