    ...
    <div className="flex flex-col gap-6">
      ...
      <UnifiedCard
        headerProps={{
          ...
          tooltipDescription:
            "در این بخش تمام تراکنش‌های مالی فروشگاه به همراه جزئیات کامل نمایش داده می‌شود. هر کارت پرداخت شامل اطلاعات زیر است:\n\n• وضعیت پرداخت (موفق، در انتظار، ناموفق)\n• کد رهگیری منحصر به فرد\n• مشخصات سفارش و کاربر\n• مبلغ پرداختی به همراه تخفیف و هزینه ارسال\n• اطلاعات دستگاه کاربر (IP، مرورگر، سیستم‌عامل)\n• تاریخ و زمان دقیق تراکنش\n\nبا کلیک روی هر کارت می‌توانید جزئیات بیشتری مانند لاگ درگاه پرداخت و اطلاعات فنی را مشاهده کنید.",
        }}
        isLoading={isLoading}
