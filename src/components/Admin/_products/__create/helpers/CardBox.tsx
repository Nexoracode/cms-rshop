            ...
            <CardBody className="flex flex-col sm:flex-row gap-4 p-2">
                <div className="w-full flex flex-col sm:flex-row justify-between items-center">
                    <div className="w-full sm:w-fit flex flex-col sm:flex-row sm:items-center gap-3 text-start">
                        {imageFile && (
                            <img
                                src={typeof imageFile === "object" ? URL.createObjectURL(imageFile) : imageFile}
                                alt="preview"
                    ...
                    <div className="w-full sm:w-fit flex flex-row mt-3 sm:mt-0 sm:flex-col gap-2">
                        <Button size="sm" className="w-full text-xl bg-danger-100 text-danger-600" radius="md" onPress={onDelete}>
                            <TiDeleteOutline />
                        </Button>
                        <Button size="sm" className="w-full text-xl bg-green-100 text-green-600" radius="md" onPress={onEdit}>
                            <TbEdit />
                        </Button>
                    </div>
                </div>
