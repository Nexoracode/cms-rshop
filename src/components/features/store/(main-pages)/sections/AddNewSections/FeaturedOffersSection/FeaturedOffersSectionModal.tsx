...
import { feauturedSectionValidation } from "./feautured-section-validation";
...
const FeaturedOffersSectionModal: React.FC<Props> = ({
  defaultValues,
  isOpen,
  onOpenChange,
}) => {
...
export default FeaturedOffersSectionModal;
